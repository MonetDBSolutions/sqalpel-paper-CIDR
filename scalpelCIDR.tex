...
shared more widely to steerd technical innovations?  Wouldn't we
...
with the target systems. It is a pity over 150 project forks
...
products can be illustrated with the recently started EU project \footnote{https://www.databench.eu}
and finished EU project Hobbit\footnote{ https://project-hobbit.eu}. 
...
This immediately takes TPC benchmarking outside the realm of where it is used nowadays, i.e.\ a
...
When a holistic comparison with mature products is not desirable, small-scale
...
\emph{contributors} are invited to run the experiments in their own DBMS context.
...
in an error are shown as yellow dots. Note that they can be morphed into
